...
namespace AudioShell.Extensions.Flac
{
    struct IoCallbacks
    {
        internal SafeNativeMethods.IOCallbacksReadCallback Read;

        internal SafeNativeMethods.IOCallbacksWriteCallback Write;

        internal SafeNativeMethods.IOCallbacksSeekCallback Seek;

        internal SafeNativeMethods.IOCallbacksTellCallback Tell;

        internal SafeNativeMethods.IOCallbacksEofCallback Eof;

        internal SafeNativeMethods.IOCallbacksCloseCallback Close;
    }
}
