...
{
    /// <summary>
    /// Specifies that an <see cref="IAudioInfoDecoder"/> implemented in an extension assembly should be automatically
    /// imported and used by AudioShell at runtime.
    /// </summary>
    /// <remarks>
    /// The attributed <see cref="IAudioInfoDecoder"/> will be used to create <see cref="AudioInfo"/> objects which
    /// describe a specified stream.
    /// </remarks>
    ...
    public sealed class AudioInfoDecoderExportAttribute : ExportAttribute
    {
        ...
        /// The file extension supported by the attributed <see cref="IAudioInfoDecoder"/>.
        /// </param>
